...
//        }
    ...
    private Connection getConnection() throws SQLException {
        if(null != jdbcConnectionConfiguration.getPassword()){
            Connection connection = ConnectionFactory.getInstance().getConnection(
                    jdbcConnectionConfiguration);

            return connection;
        }else{
            TGroupDataSource dataSource = new TGroupDataSource(jdbcConnectionConfiguration.getConnectionURL(), jdbcConnectionConfiguration.getDriverClass());
            dataSource.init();
